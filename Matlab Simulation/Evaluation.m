...
for i = 1: size(worldVertexes,1)-1                
   plot([worldVertexes(i,1) worldVertexes(i+1,1)],[worldVertexes(i,2) worldVertexes(i+1,2)],'Color','r','LineWidth',2);                    
end
for i = 1:amountAgent
   ...
   dataVMX(i,1:2) = dataVMX(i,3); % Filter of initial signals 
   dataVMY(i,1:2) = dataVMY(i,3);
