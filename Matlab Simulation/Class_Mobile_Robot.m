% %% UNICYCE DYNAMIC WAS MOVED DIRECTLY INTO THE AGENT_CONTROLLER CLASS 
% This class can be later used to consider precise unicycle dynamic. For
% coverage control, only the pose is the main concern
%
%
