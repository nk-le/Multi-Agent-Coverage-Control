function [simConfig, regionConfig, agentConfig] = Config()
    ...
    agentConfig.vConstList = 15 .* ones(1,simConfig.nAgent); % linspace(10, 20, nAgent) .* ones(1,nAgent);
    agentConfig.wOrbitList = 0.8 .* ones(1,simConfig.nAgent); % linspace(0.4, 0.8, nAgent) .* ones(1,nAgent);
