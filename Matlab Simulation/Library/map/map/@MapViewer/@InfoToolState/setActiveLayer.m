...
%--------------------------------------------------------------
function showInfoBox(hSrc,~,this,viewer,activeLayerHandles)
...
set(f,'Units','points','Position',pos);
...
pos = this.Viewer.getPosition('points');
