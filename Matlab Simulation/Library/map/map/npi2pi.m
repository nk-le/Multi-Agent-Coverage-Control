...
%
%   NEWLON = NPI2PI(LON, ANGLEUNITS) works in the units defined by
%   ANGLEUNITS, which can be either 'degrees' or 'radians'. ANGLEUNITS may
%   be abbreviated and is case-insensitive.
%
...
otherwise
    validateattributes(method, {'string','char'}, {'nonempty','scalartext'})
