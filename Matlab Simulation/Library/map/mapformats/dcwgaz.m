...
%
% DCWGAZ will be removed in a future release. The VMAP0 dataset has
% replaced DCW and can be explored using VMAP0UI.
%
...
% Warn that this function is being removed. This function calls dcwrhead
% and dcwread. Turn off the warning for dcwrhead and dcwread until this
% function ends to prevent multiple warning messages.
warning(message('map:removing:dcwgaz','DCWGAZ'))
w = warning;
warning('off', 'map:removing:dcwrhead');
warning('off', 'map:removing:dcwread');
