...
if ~isstruct(s)
   error('map:vmap0styles:mapformatsError', ...
...
savedDflt = RandStream.setGlobalStream(RandStream('swb2712','seed',0));
...
RandStream.setGlobalStream(savedDflt);
...
case 'exact'
	searchstr(end+1) = 13; % added a line-ending character above to prevent matches across rows
...
% RAILROADTIES constructs railroad tie line segments at 5 nm intervals
