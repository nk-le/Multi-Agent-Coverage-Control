...
%
% DCWREAD will be removed in a future release. The VMAP0 dataset has
% replaced DCW and can be read using VMAP0READ.
%
...
% Turn off the warning for dcwrhead until this function ends to prevent
% multiple warning messages.
warning(message('map:removing:dcwread','DCWREAD'))
w = warning('off', 'map:removing:dcwrhead');
