...
%
%   TGRLINE will be removed in a future release. More recent TIGER/Line
...
warning(message('map:removing:tgrline','TGRLINE'))
...
validYears = {'1990', '1992', '1994', '1995', '1999', '2000', '2003', '2004'};
year = str2double(validatestring(year, validYears, mfilename, 'YEAR', 2));
switch year
    case 2004, ext = '.RT';
    case 2003, ext = '.RT';
    case 2002, ext = '.RT';
...
while ~eof
    ...
    elseif isempty(t) | strcmpi(t,char(26))
