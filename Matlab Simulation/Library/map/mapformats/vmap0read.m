...
%
% [struc,field,varlen,description] = VMAP0READ ...  adds the character
% vector describing the contents of the file to the output arguments.
%
...
if nargin >= 2
	...
	fid = fopen([filepath,filename], 'rb', 'ieee-le', 'utf-8');
