function varargout = projlist(listmode)
...
%  availability. LISTMODE is 'mapprojection', 'geotiff', 'geotiff2mstruct',
%  or 'all'. The default value is 'mapprojection'.
%
...
%  --------        ----------------------------------
%  mapprojection   Lists the map projection IDs that PROJFWD and PROJINV
%                  implement using the PROJ library.
...
if nargin == 1
  ...
  inputStr = validatestring(listmode, validStrings, mfilename, 'LISTMODE', 1);
