...
%
%    WORLDFILEREAD will require three input arguments in a future release.
%    Use WORLDFILEREAD(worldFileName, coordinateSystemType, rasterSize)
%    instead of WORLDFILEREAD(worldFileName).
%
...
%   coordinateSystemType, which can be either 'planar' (including projected
%   map coordinate systems) or 'geographic' (for latitude-longitude
%   systems). The rasterSize input should match to the size of the image
%   corresponding to the world file.
%
