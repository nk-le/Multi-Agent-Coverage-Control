...
%   UNITS to define the angle unit of the outputs ARCLEN and AZ and
%   the input latitude-longitude coordinates.  UNITS may equal 'degrees'
%   (the default value) or 'radians'.
%
%   [ARCLEN, AZ] = DISTANCE(LAT1,LON1,LAT2,LON2,ELLIPSOID,UNITS) uses UNITS
%   to specify the units of the latitude-longitude coordinates, but the
%   output range has the same units as the semimajor axis of the ellipsoid.
%
%   [ARCLEN, AZ] = DISTANCE(TRACK,...) uses the input TRACK to
